...
module.exports = (api) => {
  ...
  api.metasync.DataCollector.prototype.on = api.metasync.Collector.on;

  api.metasync.DataCollector.prototype.emit = api.metasync.Collector.emit;
  ...
  api.metasync.KeyCollector.prototype.on = api.metasync.Collector.on;

  api.metasync.KeyCollector.prototype.emit = api.metasync.Collector.emit;
