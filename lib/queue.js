...
Queue.prototype.add = function(
  ...
  factor = 0, // number/string (optional), type, source, destination or path
...
Queue.prototype.next = function(
  task // next task [item, factor, priority]
) {
  const item = task[0];
  let timer;
  this.count++;
...
Queue.prototype.priority = function(
  flag = true // default: true, use false to disable priority mode
) {
  this.priorityMode = flag;
  return this;
};

Queue.prototype.factor = function(
  flag = true // default: true, use false to disable factor mode
) {
